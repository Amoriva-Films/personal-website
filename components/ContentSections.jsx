        ...
        <div className="gallery-grid" style={{
          ...
          <FadeIn delay={0.1} style={{ overflow: 'hidden', borderRadius: '4px', position: 'relative' }}>
            <div style={{ overflow: 'hidden', borderRadius: '4px', position: 'relative', height: '100%' }}>
              <Image src="/images/Bild-33.jpg" alt="Braut Getting Ready Fine Art Hochzeitsfotografie Wolfsburg – Amoriva Films" fill style={{ objectFit: 'cover', objectPosition: 'center', transition: 'transform 0.8s ease' }} sizes="(max-width: 768px) 100vw, 50vw"
                onMouseEnter={e => { e.currentTarget.style.transform = 'scale(1.04)'; }}
                onMouseLeave={e => { e.currentTarget.style.transform = 'scale(1)'; }} />
            </div>
          </FadeIn>
